		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-inverse" role="navigation">
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									...
									<li class="active"><a href="<?php echo site_url('login/logout/') ?>" onclick="return confirm('Anda Yakin Akan MeLogout')">Log Out</a></li>
									</ul>
								</div><!-- /.navbar-collapse -->
						</div>
						</nav>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<a class="btn btn-primary" href="<?php echo site_url()?>/pegawai/create" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Input Data Pegawai</a>
						<br>
						<br>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('jabatan/create/').$key->id ?>" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Jabatan</a>
